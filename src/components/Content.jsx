      ...
      <div className="Content2"> 
              <nav>
                  ...
                  <Link to="/addteachers" className="nav-links">
                      ...
                      <p className="Maintitle3">Join a supportive community of educators.</p>
                  </Link>
                  <img src={student} alt="student" height={260} />
                  <Link to="/allteachers" className="nav-links">
                      <h2 className="Maintitle2">Students</h2>
                      <p className="Maintitle3">Empower your learning journey with engaging resources.</p>
                  </Link>
                  <img src={about} alt="about" height={260} />
                  <Link to="/about" className="nav-links">
                      <h2 className="Maintitle2">About Us</h2>
                      <p className="Maintitle3">Discover how Class Compass can unlock your educational potential.</p>
                  </Link>
              </nav>
          </div></>
  );
